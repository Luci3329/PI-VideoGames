    ...
    return (
        ...
        <nav class="navbar navbar-expand-md navbar-light" style={{ backgroundColor: "#FFFF00" }} >
            <div className="container">
                ...
                <a class="navbar-brand"><svg xmlns="http://www.w3.org/2000/svg" width="45" height="40" fill="currentColor" class="bi bi-controller" viewBox="0 0 16 16">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item"><a href="/videogame" class="nav-link">Crea Tu Videojuego</a></li>
                        <li class="nav-item"><a href="#" class="nav-link" onClick={e => handleClick(e)}>Refrescar</a></li>
                    </ul>

                    <form class="d-flex">
                        <input class="form-control me-2" type="search" placeholder="Cuál es tu juego? " aria-label="Search"
                        value={game} onChange={e => handleInputChange(e)} />
